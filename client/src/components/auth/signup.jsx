...
const SignupComponent = () => {
  ...
  const formHandle = async (e) => {
    ...
    if (
      ...
      (formData?.email.endsWith("@protondatalabs.com") ||
        formData?.email.endsWith("@grantengine.com") ||
        formData?.email.endsWith("@kernuo.com"))
    ) {
      let res = null;
      try {
      ...
      alert(
        "Make sure you are using Grant Engine's Email and your password is greater that 8 characters"
      );
    }
  };
